...
public class OperadoresLogicosLoginArreglosOperadorTernario {
    public static void main(String[] args) {
        ...
        String mensaje = esAutenticado ? "Bienvenido ".concat(user).concat("!") : "Ususario y/o contraseña incorrecto(a)";
